   ...
   // pauseButton = () => { pauseText() }
    ...
    return (
        ...
        <div class ="container my-3">
            ...
            <button className="btn btn-primary mx-1" id="play-button" style={{background:'red' ,width:'150px'}} onClick={playButton}> Play Text</button>
            {/* <button id="pause-button" onClick={pauseButton}> Pause</button> */}
            <button className="btn btn-primary mx-1" id="stop-button" style={{background:'red' ,width:'150px'}}  onClick={stopButton}> Stop Text</button>
            <button className="btn btn-primary mx-1" id="clear-button" style={{background:'red' ,width:'150px'}}  onClick={ClearText}> Clear Text</button>
